...
Commands:
  ...
  clear-memory         Stop competition and clear runtime memory/session data, keep Web UI online
  reset-runtime        Stop competition and Web UI, then clear runtime memory/session data
