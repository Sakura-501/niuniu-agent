...
def default_tool_inventory() -> list[ToolAvailability]:
    specs = [
        ...
        ("nopac", "domain", ("track4",), "bundled wrapper under tools/bin/nopac"),
        ("nopac-scanner", "domain", ("track4",), "bundled wrapper under tools/bin/nopac-scanner"),
        ("ajpy-tomcat", "web", ("track2", "track4"), "bundled wrapper under tools/bin/ajpy-tomcat"),
        ("phpggc", "web", ("track1", "track2", "track3", "track4"), "bundled wrapper under tools/bin/phpggc"),
        ("redis-rogue-server", "service", ("track2", "track3"), "bundled wrapper under tools/bin/redis-rogue-server"),
        ("rogue-mysql-server", "service", ("track2", "track3"), "bundled wrapper under tools/bin/rogue-mysql-server"),
        ("grafana-exp", "web", ("track2",), "bundled wrapper under tools/bin/grafana-exp"),
        ...
        ("rubeus-asset", "domain", ("track4",), "bundled Windows Kerberos asset path wrapper under tools/bin/rubeus-asset"),
        ("sharphound-asset", "domain", ("track4",), "bundled Windows BloodHound collector asset path wrapper under tools/bin/sharphound-asset"),
        ("sweetpotato-asset", "privesc", ("track4",), "bundled Windows privilege-escalation asset path wrapper under tools/bin/sweetpotato-asset"),
        ("sebackupprivilege-asset", "privesc", ("track4",), "bundled Windows SeBackupPrivilege asset path wrapper under tools/bin/sebackupprivilege-asset"),
